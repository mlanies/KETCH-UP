...
### 🎯 Назначение
Бот предназначен для обучения официантов ассортименту напитков ресторана KETCH UP. Система использует искусственный интеллект для персонализированного обучения и включает геймификацию для повышения мотивации.

### 🏗️ Архитектура системы
Проект состоит из двух независимых Cloudflare Workers:

1. **Backend Worker** (`telegram-wine-bot.2gc.workers.dev`)
...
2. **Frontend Worker** (`wine-app.2gc.ru`)
